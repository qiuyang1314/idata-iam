...
CREATE TABLE `iam_app`  (
  ...
  `app_name` varchar(64)  NOT NULL COMMENT '系统应用名字',
  `app_code` varchar(20)  NOT NULL COMMENT '系统应用编码',
  `url` varchar(255)  NULL DEFAULT NULL,
  `img` varchar(64)  NULL DEFAULT NULL COMMENT '应用图片',
  `order_index` int(11) NOT NULL DEFAULT 1 COMMENT '排序',
  `app_key` mediumtext  NOT NULL COMMENT '系统应用公钥(账号)',
  `app_secret` mediumtext  NOT NULL COMMENT '系统应用私钥(密码)',
  `open_type` varchar(10)  NOT NULL COMMENT '打开方式(0默认 1跳转)',
  `useable` char(1)  NOT NULL COMMENT '是否生效',
...
CREATE TABLE `iam_config`  (
  ...
  `ctype` varchar(10)  NOT NULL DEFAULT '0' COMMENT '配置类型（0：系统配置）',
  `ccode` varchar(255)  NULL DEFAULT NULL COMMENT '配置项编码（0：密码过期时间，1：ip配置）',
  `citem` varchar(255)  NULL DEFAULT NULL COMMENT '配置项（配置中文名称）',
  `cvalue` text  NOT NULL COMMENT '配置项值',
  `order_index` varchar(255)  NOT NULL DEFAULT '1' COMMENT '排序',
  `del_flag` char(1)  NOT NULL DEFAULT '0' COMMENT '是否删除 (0否1是)',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_id` varchar(64)  NOT NULL COMMENT '创建id',
  `update_time` datetime(0) NOT NULL COMMENT '修改时间',
  `update_id` varchar(64)  NOT NULL COMMENT '修改id',
  PRIMARY KEY (`id`)
) ;
...
CREATE TABLE `iam_download`  (
  `id` varchar(64)  NOT NULL COMMENT '主键',
  `app_code` varchar(64)  NOT NULL COMMENT '系统应用编码',
  `task_id` varchar(64)  NOT NULL COMMENT '任务主键',
  `task_name` varchar(128)  NOT NULL COMMENT '任务名称 用于与任务对应',
  `dtype` varchar(64)  NOT NULL COMMENT '下载类型',
  `fpath` varchar(512)  NULL DEFAULT NULL COMMENT '存放全路径 要下载的文件存放路径',
  `md5` varchar(32)  NULL DEFAULT NULL COMMENT '文件较验值',
  `fsize` bigint(20) NULL DEFAULT NULL COMMENT '文件大小',
  `status` varchar(64)  NOT NULL COMMENT '下载状态 0-未开始 1-进行中 2-成功 3-失败',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
...
CREATE TABLE `iam_menu`  (
  ...
  `parent_ids` varchar(128)  NULL DEFAULT NULL COMMENT '所有父级编号',
  `app_id` varchar(64)  NOT NULL COMMENT '系统应用id',
  `name` varchar(128)  NOT NULL COMMENT '名称',
  `path` varchar(255)  NULL DEFAULT NULL COMMENT '菜单路径',
  `urls` mediumtext  NULL COMMENT '菜单链接',
  `site` varchar(255)  NULL COMMENT '菜单地址(页面物理地址)',
  `open_type` varchar(10)  NULL DEFAULT NULL COMMENT '打开方式',
  `type` char(1)  NOT NULL COMMENT '菜单类型(1顶菜单2左菜单3资源/按钮)',
  `menu_param` text  NULL COMMENT '菜单参数',
  ...
  `hidden` char(1)  NOT NULL COMMENT '是否显示(0显示1隐藏)',
  ...
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
  `del_flag` char(1)  NOT NULL COMMENT '删除标识',
  `code` varchar(64)  NULL DEFAULT NULL COMMENT '菜单编码(为动态菜单而添加，常存业务ID)',
  PRIMARY KEY (`id`)
);
--    COMMENT = '菜单'
...
CREATE TABLE `iam_office`  (
  `id` varchar(64)  NOT NULL COMMENT '主键',
  `parent_id` varchar(128)  NOT NULL COMMENT '父级编号',
  `parent_ids` varchar(1024)  NULL DEFAULT NULL COMMENT '所有父级编号',
  `name` varchar(255)  NOT NULL COMMENT '机构名称',
  `code` varchar(255)  NOT NULL COMMENT '机构编码',
  `paths` text  NOT NULL COMMENT '全路径名称',
  `order_index` int(10) NOT NULL COMMENT '排序',
  `app_id` varchar(64)  NULL DEFAULT NULL COMMENT '系统编码',
  `district_id` varchar(32)  NOT NULL COMMENT '行政区划',
  `otype` varchar(32)  NOT NULL COMMENT '机构类型',
  `levels` varchar(32)  NOT NULL COMMENT '机构级别',
  `address` varchar(128)  NULL DEFAULT NULL COMMENT '地址',
  `supervisor` varchar(64)  NULL DEFAULT NULL COMMENT '负责人',
  ...
  `useable` varchar(128)  NOT NULL COMMENT '是否启用',
  `del_flag` char(1)  NOT NULL COMMENT '删除标识',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
...
CREATE TABLE `iam_problem_feedback`  (
  `id` varchar(64)  NOT NULL COMMENT '主键',
  `opinion_title` varchar(255)  NULL DEFAULT NULL COMMENT '意见标题',
  `issue_system` varchar(100)  NULL DEFAULT NULL COMMENT '问题系统',
  `issue_details` varchar(1000)  NULL DEFAULT NULL COMMENT '问题详情',
  `state` varchar(1)  NULL DEFAULT NULL COMMENT '任务状态',
  `del_flag` char(1)  NOT NULL COMMENT '是否删除 (0否1是)',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_id` varchar(64)  NOT NULL COMMENT '创建id',
  `update_time` datetime(0) NOT NULL COMMENT '修改时间',
  `update_id` varchar(64)  NOT NULL COMMENT '修改id',
...
CREATE TABLE `iam_problem_photo`  (
  `id` varchar(64)  NOT NULL COMMENT '主键',
  `group_name` varchar(255)  NULL DEFAULT NULL COMMENT '组名',
  `file_id` varchar(100)  NULL DEFAULT NULL COMMENT '文件id',
  `issue_id` varchar(64)  NULL DEFAULT NULL COMMENT '问题反馈id',
  `del_flag` char(1)  NOT NULL COMMENT '是否删除 (0否1是)',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `create_id` varchar(64)  NOT NULL COMMENT '创建id',
  `update_time` datetime(0) NOT NULL COMMENT '修改时间',
...
CREATE TABLE `iam_role`  (
  ...
  `role_type` varchar(128)  NOT NULL COMMENT '角色类型(1内置2自定义)',
  `useable` char(1)  NOT NULL COMMENT '是否可用',
  `del_flag` char(1)  NOT NULL COMMENT '删除标识',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
...
CREATE TABLE `iam_role_menu`  (
  `app_id` varchar(64)  NOT NULL COMMENT '系统id',
...
CREATE TABLE `iam_role_user_code`  (
  ...
  `user_code_id` varchar(64)  NOT NULL COMMENT '账号编码'
) ;
-- COMMENT = '角色账号'
...
CREATE TABLE `iam_std_code`  (
  ...
  `code_value` varchar(100)  NOT NULL COMMENT '编码',
  `std_type` varchar(64)  NOT NULL COMMENT '所属码表',
  `useable` char(1)  NOT NULL DEFAULT '0' COMMENT '状态 (0正常1停用)',
...
CREATE TABLE `iam_std_type`  (
  `id` varchar(64)  NOT NULL COMMENT '主键',
  `std_num` varchar(100)  NOT NULL COMMENT '字典编号',
  `std_name` varchar(100)  NOT NULL COMMENT '字典名称',
  `std_type` varchar(64)  NOT NULL DEFAULT '3' COMMENT '字典类型 (0内置 1自定义)',
  `useable` char(1)  NOT NULL DEFAULT '0' COMMENT '状态 (0正常1停用)',
  `remark` varchar(500)  NULL DEFAULT NULL COMMENT '备注',
  `order_index` int(11) NOT NULL DEFAULT 1 COMMENT '排序',
  `del_flag` char(1)  NOT NULL DEFAULT '0' COMMENT '是否删除 (0否1是)',
...
CREATE TABLE `iam_sys_log`  (
  `id` varchar(64)  NOT NULL COMMENT '主键',
  `app_code` varchar(64)  NULL DEFAULT NULL COMMENT '应用编码',
  `module` varchar(255)  NULL DEFAULT NULL COMMENT '模块',
  `log_type` char(1)  NULL DEFAULT NULL COMMENT '日志类型(1普通2系统3安全4审计)',
  `remote_ip` varchar(128)  NULL DEFAULT NULL COMMENT '操作ip地址',
  `operate_type` varchar(255)  NULL DEFAULT NULL COMMENT '操作类型',
  ...
  `infos` mediumtext  NULL COMMENT '操作明细',
  `params` text  NULL COMMENT '请求参数',
  `result` text  NULL COMMENT '响应参数',
...
CREATE TABLE `iam_sys_login_log`  (
  ...
  `remote_ip` varchar(128)  NOT NULL COMMENT '操作ip地址',
  `browser` varchar(64)  NOT NULL COMMENT '浏览器',
  `os` varchar(64)  NOT NULL COMMENT '操作系统',
  `status` varchar(64)  NOT NULL COMMENT '状态',
  `msg` mediumtext  NOT NULL COMMENT '提示',
  `del_flag` char(1)  NOT NULL COMMENT '删除标识',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
...
CREATE TABLE `iam_user`  (
  ...
  `nation` varchar(32)  NULL DEFAULT NULL COMMENT '民族',
  `birthday` varchar(32)  NULL DEFAULT NULL COMMENT '出生年月',
  `id_card` varchar(18)  NULL DEFAULT NULL COMMENT '身份证号',
  `phone` varchar(32)  NULL DEFAULT NULL COMMENT '手机号码',
  `other_contact` varchar(32)  NULL DEFAULT NULL COMMENT '其他联系方式',
  `secirity_flag` char(1)  NOT NULL COMMENT '密级标识 (0核心涉密人员1重要涉密人员2一般涉密人员3非涉密人员)',
  `office_id` varchar(32)  NOT NULL COMMENT '部门',
  `user_post` varchar(32)  NULL DEFAULT NULL COMMENT '职务',
  `user_level` varchar(32)  NULL DEFAULT NULL COMMENT '级别',
  `budgeted` varchar(32)  NULL DEFAULT NULL COMMENT '编制',
  `budgeted_post` varchar(32)  NULL DEFAULT NULL COMMENT '编制职务',
  `del_flag` char(1)  NOT NULL COMMENT '删除标识',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
...
CREATE TABLE `iam_user_code`  (
  ...
  `type` varchar(10)  NULL DEFAULT NULL COMMENT '账号类型',
  `status` char(1)  NOT NULL COMMENT '状态 (0正常1锁定2禁用)',
  `pwd_update_time` datetime(0) NULL DEFAULT NULL COMMENT '密码修改时间',
  `default_roles` varchar(3072)  NULL DEFAULT NULL COMMENT '各应用默认角色',
  `del_flag` char(1)  NOT NULL COMMENT '删除标识',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
...
CREATE TABLE `iam_user_experience`  (
  ...
  `education` varchar(32)  NULL DEFAULT NULL COMMENT '学历',
  `major` varchar(32)  NULL DEFAULT NULL COMMENT '专业',
  `job_date` varchar(32)  NULL DEFAULT NULL COMMENT '参加工作时间',
  `job_experience` mediumtext  NULL COMMENT '工作经验',
  `post_experience` mediumtext  NULL COMMENT '任职经历',
...
CREATE TABLE `iam_file_info`  (
  ...
  `biz_type` varchar(32)  NOT NULL COMMENT '业务分类 （0--用户头像文件；1--首页轮播图）',
  `fname` varchar(128)  NOT NULL COMMENT '文件名称',
  `ftype` varchar(32)  NOT NULL COMMENT '文件类型',
  `fsize` bigint(20) NOT NULL COMMENT '文件大小',
  `furl` varchar(512)  NOT NULL COMMENT '文件路径',
  `file_biz_type` varchar(32)  NULL DEFAULT NULL COMMENT '文件业务分类',
  `preview_url` varchar(512)  NOT NULL COMMENT '预览路径',
  `md5` varchar(32)  NOT NULL COMMENT '文件签名值',
  `del_flag` char(1)  NOT NULL DEFAULT '0' COMMENT '删除标识 （0否1是）',
  `create_id` varchar(64)  NOT NULL COMMENT '创建人',
  `create_time` datetime(0) NOT NULL COMMENT '创建时间',
  `update_id` varchar(64)  NOT NULL COMMENT '更新人',
  `update_time` datetime(0) NOT NULL COMMENT '更新时间',
...
INSERT INTO `iam_std_code`(`id`, `code_name`, `code_value`, `std_type`, `useable`, `remark`, `order_index`, `del_flag`, `create_time`, `create_id`, `update_time`, `update_id`) VALUES ('513ad798ef8c680c6da8fe0778f826d9', '默认', '1', 'menuOpenWay', '0', '', '1', '0', '2020-06-28 16:03:09', '', '2020-06-28 16:03:09', '');
...
INSERT INTO `iam_std_code`(`id`, `code_name`, `code_value`, `std_type`, `useable`, `remark`, `order_index`, `del_flag`, `create_time`, `create_id`, `update_time`, `update_id`) VALUES ('98167367a299dff66ec38868e71054c2', '内嵌iframe', '2', 'menuOpenWay', '0', '', '2', '0', '2020-06-28 16:03:30', '', '2020-06-28 16:03:30', '');
